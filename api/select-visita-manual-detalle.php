...
try {
    ...
    $sqlSoportistas = "SELECT id_soportista FROM visitas_sitio_soportistas WHERE id_visita = :id_visita";
    ...
    error_log("Error en select-visita-manual-detalle.php: " . $e->getMessage());
    echo json_encode([
        'success' => false,
